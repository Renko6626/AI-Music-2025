...
from GA.evaluator import build_pentatonic_evaluator
...
def run_example():
    ...
    # 1. 构建五声调式评估器（新版 MultiRuleEvaluator）
    evaluator = build_pentatonic_evaluator()
    ...
    best_melody.save_midi(os.path.join(EXAMPLE_PATH, "best_melody_pentatonic.mid"))
    print("已保存最优旋律的MIDI文件为 best_melody_pentatonic.mid")
